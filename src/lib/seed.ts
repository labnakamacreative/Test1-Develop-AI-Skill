...
export const defaultConfig: BrandConfig = {
  ...
  members: [
    { id: "u1", name: "Andi (Lead)", roles: ["lead", "strategist"], active: true, accessLevel: "stakeholder" },
    { id: "u2", name: "Bella (Creative)", roles: ["creative", "copywriter"], active: true, accessLevel: "head" },
    { id: "u3", name: "Citra (Designer)", roles: ["designer", "editor"], active: true, accessLevel: "manager" },
    { id: "u4", name: "Dani (SMO)", roles: ["smo", "analyst"], active: true, accessLevel: "staff" },
  ],
